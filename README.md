...
无论是日常的划词翻译、变量命名，还是全自动化的每日新闻摘要、系统监控、智能爬虫，它都能成为你最得力的 24 小时智能员工。同时，Anywhere 也可作为 AI 服务商的集成平台，或个人提示词的理想存储与管理工具。如果遇到bug，或者新的功能反馈，欢迎加群讨论（作者喜欢打游戏、聊AI，欢迎闲聊**AI**、**游戏**、**推广自己的项目**，但是**商业推广是禁止的**哦~）

如果希望体验不依赖 uTools 的独立客户端，可以关注 [Anywhere Desktop
](https://github.com/Komorebi-yaodong/anywheredesktop)
...
**全局追问**：支持在任意系统界面选中文本、图片或文件后，一键“追问”发送到已打开的特定独立窗口中，实现跨应用的无缝工作流协作。
...
通过引入 **[Model Context Protocol (MCP)](https://modelcontextprotocol.io/)**，Anywhere 让 AI 拥有了“双手”：
...
* **易扩展**：兼容社区成千上万的 MCP 服务 (Stdio/HTTP/SSE)。
...
基于 Electron (uTools 环境) 的多窗口应用，主要结构如下：
...
1. **AI Studio (Google Gemini)**: [免费申请](https://aistudio.google.com/apikey) (需配合支持 Gemini 转 OpenAI 格式的中转使用，仅供测试使用，额度较低)。
